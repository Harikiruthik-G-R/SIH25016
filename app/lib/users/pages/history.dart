...
//         final dayNum = DateFormat('dd').format(DateTime.parse(date));
//         final monthYear = DateFormat('MMM, yyyy').format(DateTime.parse(date));
...
//           onTap: () => _showDayDetails(context, date, records),
//         );
//       },
//     ),
//   );
...
//       return _buildEmptyState(
//         'No Activities',
//         'Your check-ins and activities will appear here.',
//         Icons.timeline,
//       );
//     }
...
//                         children: [
//                           Text(
//                             DateFormat('MMM dd, yyyy').format(DateTime.parse(activity['date'])),
//                             style: TextStyle(
//                               fontSize: 12,
...
//       totalMinutes += record['duration'] ?? 0.0;
//     }
//     if (totalMinutes < 60) {
//       return '${totalMinutes.toStringAsFixed(0)}m';
//     } else {
//       final hours = (totalMinutes / 60).floor();
//       final remainingMinutes = (totalMinutes % 60).floor();
//       return '${hours}h:${remainingMinutes.toString().padLeft(2, '0')}m';
//     }
//   }

//   Color _getDayStatusColor() {
//     if (widget.records.isEmpty) return Colors.grey;
    
//     bool hasPresent = widget.records.any((r) => 
//       r['status'].toString().toLowerCase().contains('present') ||
//       r['status'].toString().toLowerCase().contains('active')
//     );
//     bool hasLate = widget.records.any((r) => 
//       r['status'].toString().toLowerCase().contains('late')
//     );
//     bool hasAbsent = widget.records.any((r) => 
//       r['status'].toString().toLowerCase().contains('absent')
//     );

//     if (hasAbsent) return const Color(0xFFF44336);
//     if (hasLate) return const Color(0xFFFF9800);
//     if (hasPresent) return const Color(0xFF4CAF50);
//     return Colors.grey;
//   }

//   @override
//   Widget build(BuildContext context) {
//     final dayColor = _getDayStatusColor();
...
//                     height: 50,
//                     decoration: BoxDecoration(
//                       color: _isExpanded ? dayColor : dayColor.withOpacity(0.9),
//                       shape: BoxShape.circle,
//                       boxShadow: [
//                         BoxShadow(
...
// void _showDayDetails(BuildContext context, String date, List<Map<String, dynamic>> records) {
...
// // Helper function for formatting duration (top-level, for use in _showDayDetails)
// String _formatDuration(double minutes) {
//   if (minutes < 60) {
//     return '${minutes.toStringAsFixed(0)}m';
//   } else {
