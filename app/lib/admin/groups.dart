...
//       'name': 'Mathematics',
//       'members': 18,
//       'description': 'Math Department Group',
...
//                 borderRadius: BorderRadius.circular(10),
//               ),
//               child: const Icon(Icons.group, color: Color(0xFF4CAF50)),
//             ),
//             const SizedBox(width: 16),
//             Expanded(
//               child: Column(
...
//       context: context,
//       builder:
//           (context) => AddGroupDialog(
//             onGroupAdded: (name, description) {
//               setState(() {
//                 _groups.add({
...
//       context,
//     ).showSnackBar(const SnackBar(content: Text('Group deleted successfully')));
//   }
// }

// // Add Group Dialog
// class AddGroupDialog extends StatefulWidget {
//   final Function(String name, String description) onGroupAdded;

//   const AddGroupDialog({super.key, required this.onGroupAdded});
...
//       widget.onGroupAdded(_nameController.text, _descriptionController.text);
//       Navigator.pop(context);
...
//       updatedGroup['description'] = _descriptionController.text;
