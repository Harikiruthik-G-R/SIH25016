...
//                   icon: const Icon(
//                     Icons.more_vert,
//                   ), // Use icon instead of full button
//                   itemBuilder:
//                       (context) => [
...
//                       _showDeleteConfirmation(location['id']);
//                     }
//                   },
//                 ),
//               ],
...
//             onLocationAdded: (name, lat, lng, radius) {
//               setState(() {
//                 _locations.add({
...
//   void _showDeleteConfirmation(String locationId) {
//     showDialog(
//       context: context,
//       builder:
//           (context) => AlertDialog(
...
//   final Function(String name, double lat, double lng, double radius)
//   onLocationAdded;
...
//                       validator: (value) {
//                         if (value?.isEmpty ?? true) return 'Enter latitude';
...
//                       keyboardType: TextInputType.number,
//                       validator: (value) {
//                         if (value?.isEmpty ?? true) return 'Enter longitude';
//                         if (double.tryParse(value!) == null)
//                           return 'Invalid number';
//                         return null;
//                       },
...
//                 keyboardType: TextInputType.number,
//                 validator: (value) {
//                   if (value?.isEmpty ?? true) return 'Enter radius';
...
//       text: widget.location['radius'].toString(),
//     );
//   }
...
//     if (_formKey.currentState!.validate()) {
//       final updatedLocation = Map<String, dynamic>.from(widget.location);
//       updatedLocation['name'] = _nameController.text;
//       updatedLocation['latitude'] = double.parse(_latController.text);
//       updatedLocation['longitude'] = double.parse(_lngController.text);
//       updatedLocation['radius'] = double.parse(_radiusController.text);

//       widget.onLocationUpdated(updatedLocation);
//       Navigator.pop(context);
//       ScaffoldMessenger.of(context).showSnackBar(
